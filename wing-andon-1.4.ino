...
void processEffects()
{
  ...
  else if (strcmp(effect, "blink1") == 0)
  {
    if (currentRed > 0 || currentBlue > 0 || currentGreen > 0)
    {
      saveRed = currentRed;
      saveBlue = currentBlue;
      saveGreen = currentGreen;
    ...
    {
      currentRed = saveRed;
      currentGreen = saveGreen;
      currentBlue = saveBlue;
      delay(800);
    }
  }
  else if (strcmp(effect, "blink2") == 0)
  {
    if (currentRed > 0 || currentBlue > 0 || currentGreen > 0)
    {
      saveRed = currentRed;
  ...
  else if (strcmp(effect, "blink3") == 0)
  {
    if (currentRed > 0 || currentBlue > 0 || currentGreen > 0)
    {
      saveRed = currentRed;
  ...
  else if (strcmp(effect, "blink4") == 0)
  {
    if (currentRed > 0 || currentBlue > 0 || currentGreen > 0)
    {
      saveRed = currentRed;
  ...
  else if (strcmp(effect, "champagne") == 0)
  {
    currentRed = 0;
    currentGreen = 0;
    currentBlue = 0;
...
void mqttReconnect()
{
  ...
  for (int attempt = 0; attempt < 3; ++attempt)
  {
    ...
    //String clientId = "light-controller-";
    //clientId += String(random(0xffff), HEX);
    const String clientId = machineId;
    // Attempt to connect
